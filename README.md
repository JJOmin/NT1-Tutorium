...
Dieses Repository enthält Materialien, Code und Rechenbeispiele zur Nachrichtentechnik. Die folgende Struktur hilft Ihnen bei der Navigation:

- `/docs`: Enthält theoretische Zusammenfassungen und Rechenanleitungen.
- `/examples`: Codebeispiele und Anwendungsfälle für Signalverarbeitung und Modulation.
- `/exams`: Beispielprüfungen und Übungsaufgaben zur Vorbereitung.
